    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/", "/login.html", "/index.html", "/profile.html", "/import-club.html", "/club.html", "/Crear_Club.html", "/estadisticas.html", "/jugadores.html", "/editar-jugador.html", "/css/**", "/js/**", "/assets/**").permitAll()
